 ...
 *    desc   : 自定义 Toast 辅助类
 */
public class ActivityToastHelper extends Handler {
    ...
    // WindowManager 辅助类
    private final ActivityLifecycleCallback mWindowHelper;
    ...
    public ActivityToastHelper(Toast toast, Application application) {
